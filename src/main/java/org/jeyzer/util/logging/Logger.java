...
package org.jeyzer.util.logging;
...
public class Logger {
    ...
    public static Logger getLogger(String name) {
        ...
        return demandLogger(name, null, new Exception().getStackTrace()[1].getClass());
    }
    ...
    public static Logger getLogger(String name, String resourceBundleName) {
        Class<?> callerClass = new Exception().getStackTrace()[1].getClass();
    ...
    public static Logger getAnonymousLogger(String resourceBundleName) {
        ...
        Logger result = new Logger(null, resourceBundleName,
        		new Exception().getStackTrace()[1].getClass(), manager);
